...
export default function Vacancy(props) {
    return (
        <section className="vacancy section content__section content__section_type_vacancy">
            <div className="vacancy__wrapper">
                ...
                <div className="vacancy__button-wrapper">
                    <button onClick={props.onVacancyButton} type="button" className="button-cta">Хочу прокачаться в ревью кода</button>
