...
import { cardDataReviewer, cardDataMentor, cardDataDesign, cardDataManager, cardDataMarketing } from "../utils/constants";
...
export default function Vacancies() {
  ...
  const items = [
    { title: 'Программирование', content: isMentor ? cardDataMentor : cardDataReviewer },
    { title: 'Аналитика', content: isMentor ? cardDataMentor : cardDataReviewer },
    { title: 'Дизайн', content: isMentor ? cardDataDesign : cardDataDesign },
    { title: 'Маркетинг', content: isMentor ? cardDataMarketing : cardDataMarketing },
    { title: 'Менеджмент', content: isMentor ? cardDataManager : cardDataManager },
  ];
